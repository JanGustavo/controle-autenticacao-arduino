...
from app.api import autenticacao  # Import do módulo de autenticação
...
app.include_router(autenticacao.router, prefix="/api/v1", tags=["autenticacao"])  # Registro da rota
